  ...
  return (
    <div className='container p-3 p-sm-5'>
      <div className='row col-md-10 mx-auto justify-content-around'>
        <h1 className='text-center mb-5'>Isten hozott!</h1>
        ...
        <div className='row justify-content-around mb-5'>
          ...
          <div className="card  mb-5 mb-lg-0 p-0 col-lg-5">
            ...
            <h5 className="card-title text-center mb-3 ps-2 pe-2">Jézus ma is elérhető?</h5>
          ...
          <div className="card p-0 col-lg-5">
            ...
            <h5 className="card-title text-center mb-3 ps-2 pe-2">ma is jó Istennel együtt lenni?</h5>
        ...
        <div className='row justify-content-around mb-5'>
          <div className="card p-0 col-lg-11">
            ...
            <h5 className="card-title text-center mb-3 ps-2 pe-2">az Ő szeretete nem változik?</h5>
        ...
        <div className='row justify-content-around mb-5'>
            <div className='btn-action-container p-0'>
              <Link to={"/contact"} className="btn btn-action d-block d-flex justify-content-between align-items-center">
                Tovább
